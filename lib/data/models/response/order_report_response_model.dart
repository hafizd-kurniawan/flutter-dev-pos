...
// Renamed from OrderResponseModel to avoid conflict with new order_response_model.dart
class OrderReportResponseModel {
  ...
  factory OrderReportResponseModel.fromJson(String str) =>
      OrderReportResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OrderReportResponseModel.fromMap(Map<String, dynamic> json) =>
      OrderReportResponseModel(
        status: json["status"],
        data: json["data"] == null
            ? []
